...
mapaBackground.src='./assets/mokemapa.webp'
...
class Mokepon{
    constructor(nombre,foto,vida,fotoMapa){this.nombre=nombre
    this.foto=foto
    this.vida=vida
    this.ataques=[]
    this.ancho=40
...
pintarMokepon(){
    ...
    let hipodogeEnemigo=new Mokepon('Hipodoge','./assets/Squirtle.webp',5,'./assets/squirtleCara.png')
    let capipepoEnemigo=new Mokepon('Capipepo','./assets/Bulbasaur.webp',5,'./assets/BulbasaurCara.png')
    let ratigueyaEnemigo=new Mokepon('Ratigueya','./assets/Charmander.webp',5,'./assets/CharmanderCara.png')
...
function secuenciaAtaque(){
    ...
    boton.disabled=true}
    else if(e.target.textContent==='💧'){ataqueJugador.push('AGUA')
    console.log(ataqueJugador)
    boton.style.background='#112f58'
    boton.disabled=true}
