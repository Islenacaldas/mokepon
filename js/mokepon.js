...
if(mokeponNombre===hipodoge){
    mokeponEnemigo =new Mokepon('Hipodoge','./assets/Squirtle.webp',5,'./assets/SquirtleCara.png',enemigo.id)
}else if(mokeponNombre===capipepo){
    mokeponEnemigo =new Mokepon('Capipepo','./assets/Bulbasaur.webp',5,'./assets/BulbasaurCara.png',enemigo.id)
}else if (mokeponNombre === ratigueya){
    mokeponEnemigo =new Mokepon('Ratigueya','./assets/Charmander.webp',5,'./assets/CharmanderCara.png',enemigo.id)
}
